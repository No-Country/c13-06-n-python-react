    ...
    <div className="flex flex-col ">
        {
          ...
          alert('Por favor, completa todos los campos.')
        }
            {
              ...
              { showLoginForm ? <div><p className="font-bold text-azul-oscuro text-3xl mb-8">Le damos la bienvenida.</p>
        ...
        <button onClick={()=>{registrarUser()}}>Registrar Usuario</button>
        </form>
        </div>:            
              <Registro setShowLoginForm ={setShowLoginForm} setShowRegistro={setShowRegistro} 
              email={email} contraseña={contraseña} handleemail={handleemail} handlecontraseña={handlecontraseña}/>
            }
